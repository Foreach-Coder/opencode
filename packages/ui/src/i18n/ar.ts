export const dict = {
  ...
  "ui.responseAnnotation.count.one": "{{count}} annotation",
  "ui.responseAnnotation.count.other": "{{count}} annotations",
  "ui.responseAnnotation.openCount.one": "Open {{count}} annotation",
  "ui.responseAnnotation.openCount.other": "Open {{count}} annotations",
  "ui.responseAnnotation.reference": "Annotation {{index}}",
  "ui.responseAnnotation.open": "Open annotation {{index}}",
  "ui.responseAnnotation.details": "Annotation {{index}} details",
  "ui.responseAnnotation.comment": "Comment for annotation {{index}}",
  "ui.responseAnnotation.empty": "No comment",
  "ui.responseAnnotation.edit": "Edit annotation {{index}}",
  "ui.responseAnnotation.delete": "Delete annotation {{index}}",
  "ui.responseAnnotation.source": "Back to annotation {{index}} source",
  "ui.responseAnnotation.editAction": "Edit",
  "ui.responseAnnotation.deleteAction": "Delete",
  "ui.responseAnnotation.sourceAction": "Back to source",
  "ui.responseAnnotation.count.zero": "{{count}} annotations",
  "ui.responseAnnotation.openCount.zero": "Open {{count}} annotations",
  "ui.responseAnnotation.count.two": "{{count}} annotations",
  "ui.responseAnnotation.openCount.two": "Open {{count}} annotations",
  "ui.responseAnnotation.count.few": "{{count}} annotations",
  "ui.responseAnnotation.openCount.few": "Open {{count}} annotations",
  "ui.responseAnnotation.count.many": "{{count}} annotations",
  "ui.responseAnnotation.openCount.many": "Open {{count}} annotations",
