...
export const dict = {
  ...
  "ui.responseAnnotation.count.one": "{{count}} 条注释",
  "ui.responseAnnotation.count.other": "{{count}} 条注释",
  "ui.responseAnnotation.openCount.one": "打开 {{count}} 条注释",
  "ui.responseAnnotation.openCount.other": "打开 {{count}} 条注释",
  "ui.responseAnnotation.reference": "注释 {{index}}",
  "ui.responseAnnotation.open": "打开注释 {{index}}",
  "ui.responseAnnotation.details": "注释 {{index}}详情",
  "ui.responseAnnotation.comment": "注释 {{index}}的评论",
  "ui.responseAnnotation.empty": "无评论",
  "ui.responseAnnotation.edit": "编辑注释 {{index}}",
  "ui.responseAnnotation.delete": "删除注释 {{index}}",
  "ui.responseAnnotation.source": "返回注释 {{index}}来源",
  "ui.responseAnnotation.editAction": "编辑",
  "ui.responseAnnotation.deleteAction": "删除",
  "ui.responseAnnotation.sourceAction": "返回来源",
