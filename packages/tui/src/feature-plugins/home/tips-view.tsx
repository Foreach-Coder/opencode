...
const TIPS: Tip[] = [
  ...
  `Place TUI settings in {highlight}~/.config/${Brand.directory}/tui.json{/highlight} for global config`,
  ...
  `Run {highlight}${Brand.cli} serve{/highlight} for headless API access to ${Brand.name}`,
  ...
  `Run {highlight}${Brand.cli} agent create{/highlight} for guided agent creation`,
  ...
  `Run {highlight}${Brand.cli} debug config{/highlight} to troubleshoot configuration`,
