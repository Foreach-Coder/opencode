export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "{{product}}が提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、{{product}}で{{provider}}モデルを使用します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続して{{product}}で{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、{{product}}で{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続する{{product}}サーバーを切り替えます。",
  ...
  "toast.update.description": "{{product}}の新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーを{{product}}チームに報告してください: ",
  ...
  "error.chain.mcpFailed":
    'MCPサーバー "{{name}}" が失敗しました。注意: {{product}}はまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "{{product}}には無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境で{{product}}サーバーを実行します。",
  ...
  "settings.general.row.language.description": "{{product}}の表示言語を変更します",
  "settings.general.row.appearance.title": "外観",
  "settings.general.row.appearance.description": "デバイスでの{{product}}の表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description":
    "{{product}}がシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "{{product}}のテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "{{product}} の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "{{product}} は最新バージョンです。",
