export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в {{product}}.",
  ...
  "dialog.server.description": "Переключите сервер {{product}} к которому подключается приложение.",
  ...
  "toast.update.description": "Новая версия {{product}} ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде {{product}}",
  ...
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что {{product}} пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер {{product}} внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения {{product}}",
  "settings.general.row.appearance.title": "Внешний вид",
  "settings.general.row.appearance.description": "Настройте как {{product}} выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли {{product}} системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление {{product}}.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске {{product}}",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию {{product}}.",
