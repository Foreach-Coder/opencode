export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in {{product}}.",
  ...
  "dialog.server.description": "Switch which {{product}} server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "{{product}}",
  ...
  "wsl.onboarding.checkingOpencode": "Checking {{product}}...",
  "wsl.onboarding.checkingOpencodeIn": "Checking {{product}} in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating {{product}}...",
  "wsl.onboarding.updatingOpencodeIn": "Updating {{product}} in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update {{product}} in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update {{product}}",
  "wsl.onboarding.opencodeReadyIn": "{{product}} is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "{{product}} is ready.",
  "wsl.onboarding.installOpencodeIn": "Install {{product}} in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install {{product}}",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen {{product}}.",
  ...
  "toast.update.description": "A new version of {{product}} ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the {{product}} team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, {{product}} does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} includes free models so you can start immediately.",
  ...
  "app.name.desktop": "{{product}} Desktop",
  ...
  "settings.desktop.wsl.description": "Run the {{product}} server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for {{product}}",
  ...
  "settings.general.row.appearance.description": "Customise how {{product}} looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether {{product}} follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how {{product}} is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when {{product}} launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of {{product}}.",
