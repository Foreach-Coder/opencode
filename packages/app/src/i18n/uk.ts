export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у {{product}}.",
  ...
  "dialog.server.description": "Перемкніть сервер {{product}}, до якого підключається ця програма.",
  ...
  "toast.update.description": "Нова версія {{product}} ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді {{product}}",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, {{product}} ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер {{product}} всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу {{product}}",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд {{product}} на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description":
    "Виберіть, чи {{product}} використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему {{product}}.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску {{product}}",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію {{product}}.",
