export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u {{product}}-u.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u {{product}}-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u {{product}}-u.",
  ...
  "dialog.server.description": "Promijeni na koji se {{product}} server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija {{product}}-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku {{product}} timu",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" nije uspio. Napomena: {{product}} još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni {{product}} server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u {{product}}-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako {{product}} izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li {{product}} prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu {{product}}-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se {{product}} pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju {{product}}-a.",
