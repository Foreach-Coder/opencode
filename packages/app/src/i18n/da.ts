export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i {{product}}.",
  ...
  "dialog.server.description": "Skift hvilken {{product}}-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af {{product}} ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til {{product}}-teamet",
  ...
  "error.chain.mcpFailed":
    'MCP-server "{{name}}" fejlede. Bemærk, {{product}} understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør {{product}}-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for {{product}}",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan {{product}} ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om {{product}} følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan {{product}} er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når {{product}} starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af {{product}}.",
