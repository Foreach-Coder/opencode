export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no {{product}}.",
  ...
  "dialog.server.description": "Trocar para qual servidor {{product}} este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do {{product}} ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do {{product}}",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: {{product}} ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor {{product}} dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do {{product}}",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o {{product}} aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o {{product}} segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o {{product}} é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o {{product}} iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do {{product}}.",
