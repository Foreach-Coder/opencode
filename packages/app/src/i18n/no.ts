...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i {{product}}.",
  ...
  "dialog.server.description": "Bytt hvilken {{product}}-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av {{product}} ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til {{product}}-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at {{product}} ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør {{product}}-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for {{product}}",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan {{product}} ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om {{product}} skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan {{product}} er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når {{product}} starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av {{product}}.",
