export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por {{product}}",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en {{product}}.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en {{product}}.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en {{product}}.",
  ...
  "dialog.server.description": "Cambiar a qué servidor de {{product}} se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de {{product}} ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de {{product}}",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, {{product}} no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "{{product}} incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor {{product}} dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para {{product}}",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve {{product}} en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si {{product}} sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de {{product}}.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia {{product}}",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de {{product}}.",
