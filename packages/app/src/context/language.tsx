...
type PluralKey =
  ...
  | "session.review.change"
  | "settings.workspaces.sessions"
  | "settings.workspaces.count"
type PluralLookupKey = `${PluralKey}.${UiPluralCategory}`
type TranslationKey<Key extends string> = Key extends PluralLookupKey | UiI18nPluralLookupKey ? never : Key
