...
import { sessionExportDictionary, sessionExportEnglish } from "@/i18n/session-export"
import {
...
type RawDictionary = typeof en & typeof uiEn & typeof sessionExportEnglish
...
const base = i18n.flatten({ ...en, ...uiEn, ...sessionExportEnglish })
...
function loadDict(locale: Locale) {
  ...
  return load().then((next: Dictionary) => {
    const dictionary = { ...next, ...sessionExportDictionary(locale) }
    dicts.set(locale, dictionary)
    return dictionary
  })
}
