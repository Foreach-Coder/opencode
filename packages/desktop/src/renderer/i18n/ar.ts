export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من {{product}}",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من {{product}}، هل ترغب في تثبيته وإعادة تشغيله؟",
