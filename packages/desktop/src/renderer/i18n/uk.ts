export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} {{product}} завантажено. Бажаєте встановити її та перезапустити?",
  ...
  "desktop.cli.installed.message":
    "CLI встановлено до {{path}}\n\nПерезапустіть термінал, щоб використовувати команду '{{cli}}'.",
