export const dict = {
  ...
  "desktop.updater.none.message": "이미 최신 버전의 {{product}}를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "{{product}} {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
