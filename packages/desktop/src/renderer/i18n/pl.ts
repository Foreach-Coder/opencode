export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} {{product}}. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia '{{cli}}'.",
