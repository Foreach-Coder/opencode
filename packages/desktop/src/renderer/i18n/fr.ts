export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'{{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'{{product}} a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande '{{cli}}'.",
