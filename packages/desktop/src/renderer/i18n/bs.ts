export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju {{product}}-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} {{product}}-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu '{{cli}}'.",
