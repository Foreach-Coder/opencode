export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию {{product}}",
  ...
  "desktop.updater.downloaded.prompt": "Версия {{product}} {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду '{{cli}}'.",
