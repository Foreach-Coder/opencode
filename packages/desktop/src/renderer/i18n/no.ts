export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av {{product}} er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.cli.installed.message":
    "CLI installert til {{path}}\n\nStart terminalen på nytt for å bruke '{{cli}}'-kommandoen.",
