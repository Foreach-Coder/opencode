export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von {{product}} wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl '{{cli}}' zu verwenden.",
