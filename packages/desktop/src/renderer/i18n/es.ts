export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de {{product}}. ¿Quieres instalarla y reiniciar?",
