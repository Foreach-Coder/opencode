export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af {{product}}",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af {{product}} er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge '{{cli}}'-kommandoen.",
